...
class TestProxiesPageRuTranslations:
    ...
    def test_failed_to_load_proxies(self, ru_translations):
        ...
        result = ru_translations.gettext(
            "Failed to load proxies. Please refresh the page."
        )
        assert (
            result == "Не удалось загрузить прокси. Пожалуйста, обновите страницу."
    ...
    def test_list_of_configured_proxies(self, ru_translations):
        ...
        assert (
            result == "Список настроенных прокси"
    ...
    def test_loading_proxies(self, ru_translations):
        ...
        assert (
            result == "Загрузка прокси..."
        ), f"Expected 'Загрузка прокси...', got {result!r}"
    ...
    def test_working_proxy(self, ru_translations):
        ...
        assert (
            result == "Работает — последняя проверка"
    ...
    def test_testing(self, ru_translations):
        ...
        assert (
            result == "Тестирование..."
        ), f"Expected 'Тестирование...', got {result!r}"
    ...
    def test_consecutive_failures(self, ru_translations):
        ...
        assert (
            result == "последовательных ошибок"
    ...
    def test_untested(self, ru_translations):
        ...
        assert (
            result == "Не проверялся"
        ), f"Expected 'Не проверялся', got {result!r}"
    ...
    def test_authentication_failed(self, ru_translations):
        ...
        ), f"Expected 'Ошибка авторизации', got {result!r}"
    ...
    def test_no_authentication(self, ru_translations):
        ...
        assert (
            result == "Без аутентификации"
        ), f"Expected 'Без аутентификации', got {result!r}"
