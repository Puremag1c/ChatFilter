...
- sanitize_text(): Function to sanitize text
- LogSanitizer: Filter for sanitizing log records
- SanitizingFormatter: Formatter that sanitizes final output including exceptions
"""
